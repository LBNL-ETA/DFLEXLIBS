#!/usr/bin/env python3
"""Check the s223 HeatingOrCooling shapes against the example models.
...
EXPECTED = [
    ...
    "PBui", "ElecService", "DemandFlexMode",
]
...
# This is the disambiguation guarantee: without an explicit exclusion, a zone's
# three demand flexibility event targets would also match the active setpoint
# shapes, leaving the binder with four candidates per zone.
FORBIDDEN = {
    "Zone1_TPreTarSet": ["TCurZonSet", "TComZonSet"],
    "Zone1_TSheTarSet": ["TCurZonSet", "TComZonSet"],
    "Zone1_TDefSet": ["TCurZonSet", "TComZonSet"],
    "Zone2_TPreTarSet": ["TCurZonSet", "TComZonSet"],
}
...
def infer(model_path):
    ...
    # sh:class checks on the OBC-Flex aspects can resolve.
