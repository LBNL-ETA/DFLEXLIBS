...
class DRControlFunctions(Protocol):
    ...
    def shed_price_event(self):
        ... 
    def savings_mode(self):
        ...
    def qualify_zones(self):
        ...
    def shed_heat_cool_temp_zone(self):
        ...
    def shed_demand_target(self):
        ...
    def shed_heat_cool_temp_zone_rat(self):
        ...
    def rebound_heat_cool_temp_zone_rat(self):
        ...
