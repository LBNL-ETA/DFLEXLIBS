def compute_control(shed_price_event, savings_mode, qualify_zones, shed_heat_cool_temp_zone, shed_demand_target,
                    shed_heat_cool_temp_zone_rat, rebound_heat_cool_temp_zone_rat, zone_temp, 
    ...
    '''Compute the control output based on measurement and forecast values.
        ...
        shed_heat_cool_temp_zone : function
            Function that controls the shedding of heating and cooling loads.

        shed_heat_cool_ratchet : function
        ...
        rebound_ratchet_heat_cool_zone : function
    ...
    if shed_price_event(schedule_price, price_threshold_value):
        ...
        if schedule_occupancy [0] <= occ_min_threshold:
            print("savings mode")
            shed_counter_dict[zone] = 0
            new_zone_set_temp_heat, new_zone_set_temp_cool = savings_mode (zone_set_temp_heat, zone_set_temp_cool, occ_flex_set_temp_min, occ_flex_set_temp_max, zone_set_temp_heat_bas_schedule, zone_set_temp_cool_bas_schedule)
        ...
        elif qualify_zones (operation_mode, zone_temp,  schedule_occupancy, occ_min_threshold, occ_flex_set_temp_min, occ_flex_set_temp_max, non_occ_flex_set_temp_min, non_occ_flex_set_temp_max,
            ...
            if shed_counter_dict[zone] == 0:
                new_zone_set_temp_heat, new_zone_set_temp_cool, shed_counter = shed_heat_cool_temp_zone (operation_mode, zone_set_temp_heat, zone_set_temp_cool, shed_initial_adjust, 
                ...
                new_zone_set_temp_heat, new_zone_set_temp_cool, ratcheting_list = shed_heat_cool_temp_zone_rat (operation_mode, zone_temp, zone_set_temp_heat, zone_set_temp_cool, 
                                occ_flex_set_temp_min, occ_flex_set_temp_max, zone_set_temp_heat_bas_schedule, zone_set_temp_cool_bas_schedule,
        ...
        new_zone_set_temp_heat, new_zone_set_temp_cool, rebound_heat_list, rebound_cool_list, shed_counter = rebound_heat_cool_temp_zone_rat (zone_temp, zone_set_temp_heat, zone_set_temp_cool, zone_set_temp_heat_bas_schedule, zone_set_temp_cool_bas_schedule,
