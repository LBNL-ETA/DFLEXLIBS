def compute_control(shed_price_event, shed_savings_mode, zone_qualification_check, shed_single_step_adj_zone,  
                    ...
                    deadband_peak_demand_diff_error_min, reduce_VAV, shift_target_demand_mod, shift_adjust, shift_dev_threshold, degree_unit):
    ...
    if shift_price_occ_event (schedule_price, schedule_occupancy, price_threshold_value, occ_min_threshold, shift_horizon_time):
        ...
        if reduce_VAV == 0 and zone_qualification_check (operation_mode, zone_temp,  TSetMin, TSetMax, 
...
def sparql_query(graph_path, query_paths):
    ...
    return number_of_zones, zone_names, zone_temp_point, zone_set_temp_point, zone_set_temp_heat_point, zone_set_temp_cool_point, unocc_zone_set_temp_heat_point, unocc_zone_set_temp_cool_point, occ_zone_set_temp_heat_point, occ_zone_set_temp_cool_point, set_temp_min_point, set_temp_max_point, occ_sensor_point, occ_cmd_point, vav_damper_set_point, vav_discharge_temp_point, vav_reheat_command_point, ahu_supply_temp_point, ahu_supply_flow_point, ahu_supply_flow_set_point, ele_pow_point, therm_pow_point 
