...
def create_application(config_path) -> BOPTestInterface: 
    ...
    ----------
        config_path : str
            the path to a configuration file for instantiating a bestest hydronic heat pump shed application 
    Returns
    -------
        application : TestCaseInterface
            returns an instantiated bestest hydronic heat pump interface with shedding controls
'''
