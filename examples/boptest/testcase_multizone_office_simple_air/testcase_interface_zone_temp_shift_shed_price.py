...
def create_application(config_path) -> BOPTestInterface: 
    ...
    ----------
        config_path : str
            the path to a configuration file for instantiating a multizone office simple air shift and shed application 
    Returns
    -------
        application : TestCaseInterface
            returns an instantiated multizone office simple air interface with shifting and shedding controls
'''
