...
def create_application(config_path) -> BOPTestInterface: 
    ...
    ----------
        config_path : str
            the path to a configuration file for instantiating a singlezone commercial hydronic shed application 
    Returns
    -------
        application : TestCaseInterface
            returns an instantiated singlezone commercial hydronic interface with shedding controls
'''
