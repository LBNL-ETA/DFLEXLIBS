...
from dflexlibs.hvac.strategies.stra_os_c_1a_zone_temp_adjs_rat import (
    compute_control,
    sparql_query
)
from dflexlibs.hvac.protocols_os_c_1a_zone_temp_adjs_rat import (
    DRControlFunctions,
    DRControlStrategy,
    DRInterface
)
        ...
        if number_of_zones != None:
            ...
            for zone in number_of_zones:  
                ...
                shed_counter, ratchet_list, rebound_h_list, rebound_c_list, results = (self.compute_control(
                    ...
                    self.control_functions.shed_heat_cool_temp_zone_rat, self.control_functions.rebound_heat_cool_temp_zone_rat, zone_temp, 
