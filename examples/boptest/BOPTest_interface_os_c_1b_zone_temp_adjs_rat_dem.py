...
from dflexlibs.hvac.strategies.stra_os_c_1b_zone_temp_adjs_rat_dem import (
    compute_control,
    sparql_query
)
from dflexlibs.hvac.protocols_os_c_1b_zone_temp_adjs_rat_dem import (
    DRControlFunctions,
    DRControlStrategy,
    DRInterface
)
from dflexlibs.hvac.functions import (
    ...
    savings_mode,
    qualify_zones,
    shed_heat_cool_temp_zone,
    shed_demand_target,
    shed_heat_cool_temp_zone_rat, 
    rebound_heat_cool_temp_zone_rat
)
...
class BOPTestControlFunctions(DRControlFunctions):
    ...
    def __init__(self):
        ...
        self.savings_mode = savings_mode
        self.qualify_zones = qualify_zones
        self.shed_heat_cool_temp_zone = shed_heat_cool_temp_zone
        self.shed_demand_target = shed_demand_target
        self.shed_heat_cool_temp_zone_rat = shed_heat_cool_temp_zone_rat
        self.rebound_heat_cool_temp_zone_rat = rebound_heat_cool_temp_zone_rat
...
class BOPTestInterface(DRInterface):
    ...
    def control_agent(self, y, f, step, start_time_days, current_time, f_price):
        ...
        print(power_points)
        baseline_demand = get_baseline_value(baseline_df, current_time, power_points).sum()       
        ...
        demand_decrease = baseline_demand - current_demand
        demand_decrease_error = self.demand_decrease_cap - demand_decrease
        ...
        if number_of_zones != None:
            ...
            for zone in number_of_zones:  
                ...
                shed_counter, ratchet_list, rebound_h_list, rebound_c_list, results = (self.compute_control(
                    self.control_functions.shed_price_event, self.control_functions.savings_mode, self.control_functions.qualify_zones, self.control_functions.shed_heat_cool_temp_zone,  
                    self.control_functions.shed_demand_target, self.control_functions.shed_heat_cool_temp_zone_rat, self.control_functions.rebound_heat_cool_temp_zone_rat, zone_temp, 
