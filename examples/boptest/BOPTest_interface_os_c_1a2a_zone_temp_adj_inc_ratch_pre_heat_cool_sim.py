...
from dflexlibs.hvac.strategies.stra_os_c_1a2a_zone_temp_adj_inc_ratch_pre_heat_cool_sim import (
    compute_control,
    sparql_query
)
from dflexlibs.hvac.protocols_os_c_1a2a_zone_temp_adj_inc_ratch_pre_heat_cool_sim import (
    DRControlFunctions,
    DRControlStrategy,
    DRInterface
)
...
class BOPTestInterface(DRInterface):
    ...
    def __init__(self, controls, config_path):
        ...
        # Define shed values for ratcheting
        ...
        if number_of_zones != None:
            ...
            for zone in number_of_zones:  
                ...
                shed_counter, shift_counter, ratchet_list, rebound_h_list, rebound_c_list, results = (self.compute_control(
                    ...
                    self.shift_adjust, self.shift_dev_threshold, shift_horizon_time, self.degree_unit))
